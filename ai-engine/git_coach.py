        ...
        try:
            ...
            if commits:
                ...
                stats = {
                    ...
                    'insertions': 0,
                    'deletions': 0,
                    'diff_output': result_stats.stdout if result_stats.returncode == 0 else ""
                }
                ...
                stats = {'files_changed': 0, 'insertions': 0, 'deletions': 0, 'diff_output': ""}
        ...
        try:
            if not git_data['commits']:
                return {
                    ...
                    'suggestions': ['Consider making regular commits to track your progress.'],
                    'tags': ['#no-activity'],
            ...
            response = openai.ChatCompletion.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an AI code coach helping developers improve their productivity and code quality. Respond only with valid JSON."},
            ...
            try:
                ...
                required_fields = ['summary', 'suggestions', 'tags', 'productivity_score']
